...
namespace @interface
{
    public partial class Compiler : Form
    {
        ...
        {
            richTextBox2.Clear();
            new CodeAnalyzer(richTextBox1.Text, richTextBox2);
        }

        private void постановкаЗадачиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start(Path.Combine(Application.StartupPath,"Resources", "Info", "Postanovka_Zadachi.html"));
        }

        private void грамматикаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start(Path.Combine(Application.StartupPath, "Resources", "Info", "Grammatika.html"));
        }

        private void классификацияГрамматикиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start(Path.Combine(Application.StartupPath, "Resources", "Info", "Classificacia_Grammatiki.html"));
        }

        private void методАнализаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start(Path.Combine(Application.StartupPath, "Resources", "Info", "Metod_Analiza.html"));
        }

        private void диагностикаИНейтрализацияОшибкиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start(Path.Combine(Application.StartupPath, "Resources", "Info", "Diagnostika_i_Classificacia_Oshibok.html"));
        }

        private void тестовыйПримерToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start(Path.Combine(Application.StartupPath, "Resources", "Info", "Testoviy_Primer.html"));
        }

        private void списокЛитературыToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start(Path.Combine(Application.StartupPath, "Resources", "Info", "Spisok_Literatury.html"));
        }

        private void исходныйКодПрограммыToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start(Path.Combine(Application.StartupPath, "Resources", "Info", "Ishodniy_Kod_Programmy.html"));
        }
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            richTextBox2.Font = new Font(richTextBox2.Font.Name, currentSize,
            richTextBox2.Font.Style, richTextBox2.Font.Unit);
        }
